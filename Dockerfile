...
ENV HAPROXY_DEFAULTS_OPTION_HTTPCHK_ENABLE enabled
...
ENV HAPROXY_HTTP_ENABLE enabled
ENV HAPROXY_HTTPS_ENABLE enabled
ENV HAPROXY_PROXY_HTTP_ENABLE disabled
ENV HAPROXY_PROXY_HTTP_PORT 8088
